  ...
  return (
    <div className="p-6 bg-green-50   rounded-lg  ">
      ...
      <div className="grid grid-cols-3 sm:gap-6 gap-4 mb-10 ">
        <div className="p-4  flex flex-col items-center justify-center bg-green-100    rounded-lg text-center">
          <h2 className="sm:text-xl font-semibold">My Orders</h2>
          <p className="text-3xl font-bold text-[#0ec708]  ">{stats.myOrders.length}</p>
        </div>
        <div className="p-4 bg-green-100   rounded-lg text-center  flex flex-col items-center justify-center">

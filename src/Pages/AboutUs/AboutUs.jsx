...
const AboutUs = () => {
  return (
   ...
   <Navbar/>
   <section className="">
     <div className=" pt-30 px-6 md:px-12 lg:px-24 pb-3  bg-green-50  flex flex-col justify-center items-center">
      <motion.div
      ...
      >
        <h2 className="text-4xl font-extrabold text-gray-800 mb-4 ">
          About <span className="text-[#012200]  ">BiteLog</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          <Users className="w-12 h-12 mx-auto text-[#012200]  mb-4" />
          <h3 className="text-lg font-bold mb-2 text-black ">Student Friendly</h3>
        ...
        <motion.div
          ...
          className="bg-white  shadow-lg rounded-2xl p-6 text-center hover:shadow-xl transition"
        >
          <UtensilsCrossed className="w-12 h-12 mx-auto text-[#012200]  mb-4" />
          <h3 className="text-lg font-bold mb-2 text-black ">Meal Management</h3>
          <p className="text-sm text-gray-600 ">
        ...
        <motion.div
          ...
          className="bg-white  shadow-lg rounded-2xl p-6 text-center hover:shadow-xl transition"
        >
          <ShieldCheck className="w-12 h-12 mx-auto text-[#012200]  mb-4" />
          <h3 className="text-lg font-bold mb-2 text-black ">Secure & Reliable</h3>
          <p className="text-sm text-gray-600 ">
        ...
        <motion.div
          ...
          className="bg-white  shadow-lg rounded-2xl p-6 text-center hover:shadow-xl transition"
        >
          <Star className="w-12 h-12 mx-auto text-[#012200]  mb-4" />
          <h3 className="text-lg font-bold mb-2 text-black ">Membership Badges</h3>
          <p className="text-sm text-gray-600 ">

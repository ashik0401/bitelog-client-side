...
const AddMeal = () => {
  ...
  return (
    <div className="md:max-w-xl md:mx-auto p-3  ">
      <h2 className="text-3xl font-bold mb-4 text-center text-[#012200]">Add New Meal</h2>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 t">
        ...
        <button type="submit" className="btn  w-full bg-[#012200]  border-gray-500  ">Add Meal</button>
      </form>
    </div>
  );
};

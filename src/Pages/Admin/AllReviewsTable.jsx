...
const AllReviewsTable = () => {
    ...
    return (
        <div className="p-6">
            <h2 className="text-2xl font-bold mb-4">All Meal Reviews</h2>
            <div className="overflow-x-auto">
                <table className="table table-zebra w-full">
                    ...
                    <tbody>
                        {meals.map((meal) => (
                            <tr key={meal._id}>
                                <td className="">{meal.title}</td>
                                <td className="text-center">{meal.likes}</td>
                                <td className="text-center">{meal.reviews_count}</td>
                                <td className="flex items-center justify-center space-x-2   text-center">
                                    <button
                                        className="btn btn-xs btn-info  mb-0 "

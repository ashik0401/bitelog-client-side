      ...
      {!isFetching && users.length > 0 && (
        <div className="overflow-x-auto">
          <table className="table w-full border border-gray-300">
            <thead>
              <tr>
                <th className="border border-gray-300 text-center">Username</th>
            ...
            <tbody>
              {users.map(user => (
                <tr key={user._id}>
                  <td className="border border-gray-200 text-center font-medium">{user.name?.toUpperCase()}</td>
                  <td className="border border-gray-200 text-center">{user.email}</td>
                  <td className="border border-gray-200 text-center">{user.subscriptionStatus || 'Not Subscribed'}</td>
